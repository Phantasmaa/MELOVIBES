<nav class="col-md-2 d-none d-md-block sidebar pt-2" id="barra_izquierda">
    <div class="d-flex flex-column justify-content-between h-100">      
        ...
        <div class="text-center">
            <button class="btn btn-primary mt-3" id="crear_pub" data-bs-toggle="modal"  data-bs-target="#createPublicationModal">Crear publicaci�n <i class="bi bi-music-note-beamed"></i></button> 
        </div>
